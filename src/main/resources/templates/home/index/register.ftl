                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form action="" id="register-form">
                                        ...
                                        <h4 class="text-primary my-4">注册【在线聊天系统】在线聊天系统账号</h4>
                                        ...
                                        <div class="form-row mb-3">
                                            <div class="col-sm-12">
                                                <div class="custom-control custom-checkbox text-left">
                                                    ...
                                                    <label class="custom-control-label font-14" for="terms">我同意<a href="javascript:void(0)" id="show-policy">《在线聊天系统在线聊天系统政策》</a></label>
                                                </div>                                
                                            </div>
                                        </div>                          
